...
DROP DATABASE  IF EXISTS `gu3006913`;
CREATE DATABASE  IF NOT EXISTS `gu3006913` CHARSET utf8;
...
(4,'abc@localhost','12346',1,'abc','1234678901','Rua A','B','C','DE','01234987','115555-5555','','N');usuariosusuarios
