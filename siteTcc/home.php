					...
					<div class="col-lg-6 mb-0 d-flex align-items-center">
						<div class="text-align-left align-self-center">
							<h1 class="h2 text-dark">
								<b>Body</b> <span class="text-orange">eCommerce</span>
							</h1>
							<h3 class="h3">Venha conhecer a BodyFitness!</h3>
							<p>
								BodyFitness é um eCommerce que veio para suprir suas necessidades 
								de comprar roupas de qualidade por um preço que cabe no seu bolso. 
								Venha conhecer nossas lojas pessoalmente
								<a  class="text-orange" href="contato.php" target="_blank">Lojas Físicas</a>
								.
							</p>
						</div>
					</div>
			...
			<div class="col-12 col-md-4 mb-4">
				<div class="card h-100">
					...
					<div class="card-body">
						...
						<a href="shop-single.html"
							class="h2 text-decoration-none text-dark">Summer Addides Shoes</a>
						<p class="card-text">Curabitur ac mi sit amet diam luctus porta.
							Phasellus pulvinar sagittis diam, et scelerisque ipsum lobortis
							nec.</p>
